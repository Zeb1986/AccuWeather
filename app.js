...
//Temp
document.querySelector('.day-1-temp').innerHTML ='Температура, Минимум: ' + data.DailyForecasts[0].Temperature.Minimum.Value + '&deg' + ' Максимум: ' + data.DailyForecasts[0].Temperature.Maximum.Value + '&deg';
document.querySelector('.day-2-temp').innerHTML ='Температура, Минимум: ' + data.DailyForecasts[1].Temperature.Minimum.Value + '&deg' + ' Максимум: ' + data.DailyForecasts[1].Temperature.Maximum.Value + '&deg';
    document.querySelector('.day-3-temp').innerHTML ='Температура, Минимум: ' + data.DailyForecasts[2].Temperature.Minimum.Value + '&deg' + ' Максимум: ' + data.DailyForecasts[2].Temperature.Maximum.Value + '&deg';
    document.querySelector('.day-4-temp').innerHTML ='Температура, Минимум: ' + data.DailyForecasts[3].Temperature.Minimum.Value + '&deg' + ' Максимум: ' + data.DailyForecasts[3].Temperature.Maximum.Value + '&deg';
    document.querySelector('.day-5-temp').innerHTML ='Температура, Минимум: ' + data.DailyForecasts[4].Temperature.Minimum.Value + '&deg' + ' Максимум: ' + data.DailyForecasts[4].Temperature.Maximum.Value + '&deg';
    //wind
